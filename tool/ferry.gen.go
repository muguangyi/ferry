...
// Register to ferry
var (
{{range $index, $target := .targets}}{{$target.Proxy}}succ bool = ferry.Register("{{$target.Name}}", func(sandbox ferry.ISandbox) interface{} { return &{{$target.Proxy}}{sandbox: sandbox} })
{{end}}
)
`
