...
const gencode = `
//
// This code was generated by ship tool.
// 
...
// Register to ship
var (
{{range $index, $target := .targets}}{{$target.Proxy}}succ bool = ship.Register("{{$target.Name}}", func(sandbox ship.ISandbox) interface{} { return &{{$target.Proxy}}{sandbox: sandbox} })
{{end}}
)
`
